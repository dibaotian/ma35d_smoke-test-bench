...
./ffmpeg_cmd.sh h264dec ../videos/TheaterSquare_640x360.h264.mp4 h264dec.out $device_type # fail
...
./ffmpeg_cmd.sh hevcdec ../videos/video-h265.mkv hevcdec.out $device_type   # fail
...
./ffmpeg_cmd.sh av1dec ../videos/CityHall_1920x1080.av1.webm $device_type   # fail

./ffmpeg_cmd.sh vp9dec ../videos/UshaikaRiverEmb_1920x1080.vp9.webm $device_type   # fail

./ffmpeg_cmd.sh h264enc ../videos/akiyo_qcif.y4m $device_type #fail
...
./ffmpeg_cmd.sh av1enc ../videos/akiyo_qcif.y4m $device_type # fail

./ffmpeg_cmd.sh  h264toh264 ../videos/TheaterSquare_640x360.h264.mp4 h264toh264.out $device_type   # fail, process hang
# echo $?
...
# ./ffmpeg_cmd.sh  h264toav1 ../videos/TheaterSquare_640x360.h264.mp4 h264toav1.out $device_type   #fail, process hang
# ffprobe -v error -show_entries format=duration -of default=noprint_wrappers=1:nokey=1 -i ../videos/TheaterSquare_640x360.h264.mp4
...
# ./ffmpeg_cmd.sh  av1toav1 ../videos/CityHall_1920x1080.av1.webm $device_type
